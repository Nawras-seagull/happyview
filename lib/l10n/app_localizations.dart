...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Privacy Policy for Happy View\n\n1. No User Registration\n- Our app does not require user registration.\n- We do not collect personal identifying information from children.\n\n2. Data We Process\n- The app uses our own backend service to fetch safe images and to relay parent-submitted suggestions.\n- If a parent chooses to submit feedback through the parental gate, the message content and optional email address are sent to our backend and then relayed to our Telegram inbox for review. This is used only to respond to the message or improve the app.\n- We do not use analytics or advertising SDKs, and we do not collect device advertising identifiers (AAID/IDFA), precise location data, or other tracking identifiers.\n\n3. Third-Party Services\n- Images are requested through our backend service rather than directly from third-party providers.\n- Suggestions are transmitted to our backend and then relayed to our Telegram bot for handling.\n- We do not sell or share personal data with advertisers.\n\n4. Parent Consent\n- The suggestion form is only available behind a parental gate.\n- By submitting feedback, a parent agrees to the limited information described above.\n\n5. Contact\nFor privacy questions: developer@nawras.tech'**
