...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get privacyPolicyContent =>
      'سياسة الخصوصية لتطبيق Happy View\n\n1. لا يوجد تسجيل مستخدم\n- تطبيقنا لا يتطلب تسجيل المستخدم\n- لا يتم جمع أي معلومات تعريف شخصية من الأطفال\n\n2. جمع البيانات\n- نستخدم Firebase (Cloud Firestore) لتخزين الاقتراحات المقدمة عبر نموذج ملاحظات محمي ببوابة أولياء الأمور\n- قد تتضمن الاقتراحات المقدمة عنوان بريد إلكتروني اختياري، يُقدَّم فقط إذا اختار أحد الوالدين إدراجه، ويُستخدم فقط للرد على الاستفسار\n- لا نستخدم أدوات تحليلات أو إعلانات، ولا نجمع معرّفات الإعلانات الخاصة بالجهاز (AAID/IDFA) أو بيانات الموقع الدقيقة\n\n3. خدمات الطرف الثالث\n- يتواصل التطبيق بشكل آمن مع خدمة الخلفية (backend) الخاصة بنا لجلب صور آمنة، ولا يتم إرسال أي بيانات مستخدم أثناء هذه العملية\n- Firebase (Cloud Firestore) لتخزين الاقتراحات المقدمة من أولياء الأمور\n- لا يتم بيع أو مشاركة البيانات الشخصية\n\n4. موافقة المستخدم\n- نموذج الاقتراحات لا يمكن الوصول إليه إلا عبر بوابة أولياء الأمور\n- بإرسال اقتراح، يوافق ولي الأمر على البيانات الاختيارية الموضحة أعلاه\n\n5. الاتصال\nللاستفسارات المتعلقة بالخصوصية: developer@nawras.tech';
