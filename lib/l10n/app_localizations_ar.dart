...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get privacyPolicyContent =>
      'سياسة الخصوصية لتطبيق Happy View\n\n1. لا يوجد تسجيل مستخدم\n- لا يتطلب التطبيق تسجيل مستخدم.\n- لا نجمع معلومات تعريف شخصية من الأطفال.\n\n2. البيانات التي نعاملها\n- يستخدم التطبيق خدمة الخلفية الخاصة بنا لجلب الصور الآمنة ولإرسال الاقتراحات المقدمة من الوالدين.\n- إذا اختار أحد الوالدين إرسال ملاحظات عبر البوابة الأبوية، يتم إرسال محتوى الرسالة وبريد إلكتروني اختياري إلى خادمنا ثم نقله إلى صندوقنا على Telegram للمراجعة. يُستخدم هذا فقط للرد على الرسالة أو تحسين التطبيق.\n- لا نستخدم أدوات تحليل أو إعلانات، ولا نجمع معرّفات الإعلانات الخاصة بالجهاز (AAID/IDFA)، أو بيانات الموقع الدقيقة، أو أي معرّفات تتبع أخرى.\n\n3. خدمات الطرف الثالث\n- يتم طلب الصور عبر خدمة الخلفية الخاصة بنا بدلًا من التواصل المباشر مع مزودين خارجيين.\n- يتم إرسال الاقتراحات إلى خادمنا ثم نقلها إلى روبوت Telegram الخاص بنا للتعامل معها.\n- لا نبيع أو نشارك البيانات الشخصية مع المعلنين.\n\n4. موافقة الوالدين\n- نموذج الاقتراحات متاح فقط خلف بوابة أبوية.\n- بإرسال الملاحظات، يوافق الوالد على المعلومات المحدودة الموضحة أعلاه.\n\n5. التواصل\nلأسئلة الخصوصية: developer@nawras.tech';
