...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get privacyPolicyContent =>
      'Privacy Policy for Happy View\n\n1. No User Registration\n- Our app does not require user registration\n- No personal identifying information is collected from children\n\n2. Data Collection\n- We use Firebase (Cloud Firestore) to store suggestions submitted through a parent-gated feedback form\n- Submitted suggestions may include an optional email address, provided only if a parent chooses to include one, used solely to respond to the inquiry\n- We do not use analytics or advertising SDKs, and we do not collect device advertising identifiers (AAID/IDFA) or precise location data\n\n3. Third-Party Services\n- The app communicates securely with our own backend service to retrieve safe images; no user data is sent during this process\n- Firebase (Cloud Firestore) for storing parent-submitted suggestions\n- No personal data sold or shared\n\n4. User Consent\n- The suggestion form is only accessible behind a parental gate\n- By submitting a suggestion, a parent agrees to the optional data described above\n\n5. Contact\nFor privacy inquiries: developer@nawras.tech';
